...
public class SnowmanModel<T extends SnowmanEntity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(TutorialMod.MOD_ID, "snowman"), "main");	private final ModelPart root;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition base = root.addOrReplaceChild("base", CubeListBuilder.create().texOffs(0, 66).addBox(-6.0F, -13.0F, -7.0F, 12.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
				...
				.texOffs(0, 37).addBox(-6.0F, -1.0F, -6.0F, 12.0F, 1.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition left_pointy = left_hand.addOrReplaceChild("left_pointy", CubeListBuilder.create().texOffs(20, 100).addBox(0.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 0.0F, -1.0F));
		...
		PartDefinition right_arm = middle.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(36, 83).mirror().addBox(-5.9907F, -0.5F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-6.0F, -8.0F, 0.0F));

		PartDefinition right_elbow = right_arm.addOrReplaceChild("right_elbow", CubeListBuilder.create().texOffs(92, 65).mirror().addBox(-6.0157F, -0.5F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-5.975F, 0.0F, 0.0F));

		PartDefinition right_hand = right_elbow.addOrReplaceChild("right_hand", CubeListBuilder.create().texOffs(10, 95).mirror().addBox(-2.0F, -0.4399F, -1.5F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-6.0157F, -0.0601F, 0.0F));

		PartDefinition right_thumb = right_hand.addOrReplaceChild("right_thumb", CubeListBuilder.create().texOffs(18, 79).mirror().addBox(-0.5F, -0.4399F, -3.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-0.5F, 0.0F, -1.5F));

		PartDefinition right_thum_tip = right_thumb.addOrReplaceChild("right_thum_tip", CubeListBuilder.create().texOffs(10, 99).mirror().addBox(-0.5F, -0.4399F, -4.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, -3.0F));

		PartDefinition right_pointy = right_hand.addOrReplaceChild("right_pointy", CubeListBuilder.create().texOffs(20, 100).mirror().addBox(-4.0F, -0.4399F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-2.0F, 0.0F, -1.0F));

		PartDefinition right_pointy_tip = right_pointy.addOrReplaceChild("right_pointy_tip", CubeListBuilder.create().texOffs(100, 12).mirror().addBox(-4.0F, -0.463F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.6762F, 0.0232F, 0.0F));

		PartDefinition right_pinkie = right_hand.addOrReplaceChild("right_pinkie", CubeListBuilder.create().texOffs(100, 16).mirror().addBox(-3.5F, -0.4399F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-1.5F, 0.0F, 0.0F));

		PartDefinition right_pinkie_tip = right_pinkie.addOrReplaceChild("right_pinkie_tip", CubeListBuilder.create().texOffs(100, 14).mirror().addBox(-4.0F, -0.4399F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.5F, 0.0F, 0.0F));

		PartDefinition head = middle.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.0F, -10.0F, 0.0F));
		...
		PartDefinition bone = head.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(88, 29).mirror().addBox(-5.0F, -6.0F, -3.0F, 1.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(88, 29).addBox(4.0F, -6.0F, -3.0F, 1.0F, 6.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(32, 50).addBox(-3.0F, -6.0F, 4.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(92, 67).addBox(-3.0F, -5.0F, -6.0F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(92, 52).addBox(-3.0F, -6.0F, -5.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(76, 13).addBox(-3.0F, 1.0F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(0, 50).addBox(-4.0F, -7.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.9696F, 0.3473F));

		PartDefinition tophat = head.addOrReplaceChild("tophat", CubeListBuilder.create(), PartPose.offset(0.0F, -7.749F, -0.9896F));
