...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> GOJI_BERRY_PLACED_KEY = registerKey("goji_berry_bush_placed");
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(context, GOJI_BERRY_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.GOJI_BERRY_BUSH_KEY),
